/*!jQuery v1.11.0 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license*//*!scrollReveal.js v0.1.2 (c) 2014 Julian Lloyd | MIT license*/window.scrollReveal=(function(window){'use strict';function scrollReveal(options){this.docElem=window.document.documentElement;this.options=this.extend(this.defaults,options);this.styleBank=[];if(this.options.init==true)this.init();}
...
var dist=parsed.move||this.options.move,dur=parsed.over||this.options.over,delay=parsed.after||this.options.after,easing=parsed.easing||this.options.easing;var transition="-webkit-transition: -webkit-transform "+dur+" "+easing+" "+delay+",  opacity "+dur+" "+easing+" "+delay+";"+
...
"opacity: 0;";var target="-webkit-transform: translate"+axis+"(0);"+
